...
const ProductItem = ({ item }: { item: Product }) => {
  ...
  return (
    <div className="group relative">
      ...
      <div className="relative overflow-hidden rounded-lg bg-[#F6F7FB] aspect-square w-full mb-4 flex items-center justify-center p-4">
        ...
        <div className="absolute left-0 bottom-0 translate-y-full w-full flex items-center justify-center gap-2.5 pb-5 ease-linear duration-200 group-hover:translate-y-0">
          ...
          <button
            ...
            className={`flex items-center justify-center w-9 h-9 rounded-[5px] shadow-1 ease-out duration-200 bg-white
              ...
              ${isWishlistAnimating ? "animate-heartBeat scale-125" : ""}
            `}
          >
            <svg
              className={`fill-current transition-all duration-300 ${isWishlistAnimating ? "scale-110" : ""}`}
              width="16"
              height="16"
              viewBox="0 0 16 16"
              fill="none"

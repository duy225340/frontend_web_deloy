...
const Footer = () => {
  ...
  const settings = useSelector((state: any) => state.settingsReducer.settings);
      ...
      <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
        ...
        <div className="flex flex-wrap xl:flex-nowrap gap-10 xl:gap-19 xl:justify-between pt-17.5 xl:pt-22.5 pb-10 xl:pb-15">
          <div className="max-w-[330px] w-full">
            ...
            <ul className="flex flex-col gap-3">
              <li className="flex gap-4.5">
                ...
                {settings?.['office_address'] || "Số 123 đường ABC, Quận XYZ, TP. Hà Nội, Việt Nam."}
              </li>
              ...
              <li>
                <a href="#" className="flex items-center gap-4.5">
                  ...
                  {settings?.['support_phone'] || "(+099) 532-786-9843"}
                </a>
              </li>
          ...
          <div className="w-full xl:max-w-[450px]">
            ...
            <div className="w-full h-[250px] rounded-lg overflow-hidden border border-gray-3 shadow-sm">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d26135.459741368926!2d105.53933432626026!3d10.528868467284214!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x310a6a3064a6adcb%3A0x9478031295c8e305!2zQ2jhu6MgQsOsbmggVGjDoG5o!5e0!3m2!1svi!2s!4v1771655028280!5m2!1svi!2s"
                width="100%"
                height="100%"
                style={{ border: 0 }}
        ...
        <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
          <div className="flex gap-5 flex-wrap items-center justify-between">
            <p className="text-dark font-medium">
              &copy; {year}. Bản quyền thuộc về Nhà có tết.
            </p>
            ...
            <div className="flex flex-wrap items-center gap-4">
              ...
              <div className="flex flex-wrap items-center gap-6">
                <a href="" aria-label="payment system with  card">
                  <Image
                    src="/images/icons/vnpayIcon.jpg"
                    alt="VnPay"
                    width={66}
                    height={22}
                  />

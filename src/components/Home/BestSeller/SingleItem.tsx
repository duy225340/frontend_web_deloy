...
const SingleItem = ({ item }: { item: Product }) => {
  ...
  return (
    <div className="group relative">
      ...
      <div className="relative overflow-hidden rounded-lg bg-[#F6F7FB] h-[403px]">
        ...
        {/* Image container cố định */}
        <div className="flex justify-center items-center aspect-square w-full overflow-hidden p-6">
        ...
        <div className="absolute right-0 bottom-0 translate-x-full u-w-full flex flex-col gap-2 p-5.5 ease-linear duration-300 group-hover:translate-x-0">
          ...
          <button
            ...
            className={`flex items-center justify-center w-9 h-9 rounded-[5px] shadow-1 ease-out duration-200 bg-white
              ${isInWishlist ? "text-red-500" : "text-dark hover:text-white hover:bg-blue"}
